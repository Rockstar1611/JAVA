...
public class digit_Nums_into_Words
{
	static void convert_to_Words(char[]num) {
		...
		if(len>4) {
			System.out.println("Lenght more than 4 is not Supported");
			return;
		}
		...
		String[] two_digits=new String[] {
				...
				"fifteen","sixteen","seveteen","eighteen","nineteen"
		};
	...
	public static void main(String[] args) {
		convert_to_Words("1323".toCharArray());
	}
}
